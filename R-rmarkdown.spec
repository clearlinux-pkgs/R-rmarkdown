...
Version  : 2.29
Release  : 97
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/rmarkdown_2.29.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/rmarkdown_2.29.tar.gz
...
popd
pushd ..
cp -a rmarkdown buildavx512
popd
pushd ..
cp -a rmarkdown buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740098595
...
/usr/lib64/R/library/rmarkdown/rmarkdown/lua/table-classes.lua
...
/usr/lib64/R/library/rmarkdown/tests/testthat/test-beamer_presentation.R
...
/usr/lib64/R/library/rmarkdown/tests/testthat/test-html_document_base.R
...
/usr/lib64/R/library/rmarkdown/tests/testthat/test-pdf_document.R
