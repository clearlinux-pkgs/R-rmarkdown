...
Version  : 1.8
Release  : 1
URL      : https://cran.r-project.org/src/contrib/rmarkdown_1.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rmarkdown_1.8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1515623384
